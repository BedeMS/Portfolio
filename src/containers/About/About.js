      ...
      <div className="About">
        ...
        <div className="Desc">
          <p className="Desc__about">
            ...
            data is passed down the component tree via props. Usually, the
            source of truth is implemented in the component that needs it for
            rendering. So in our case, we manage state in our containing app
            component at the very top. From this app component, data is passed
            down the component tree via props. Usually, the source of truth is
            implemented in the component that needs it for rendering. So in our
            case, we manage state in our containing app component at the very
            top. From this app component, data is passed down the component tree
            via props.
          </p>

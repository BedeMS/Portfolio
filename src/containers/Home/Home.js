      ...
      <div className="Intro">
        ...
        <div className="perspective">
          <div className="Project__a">
            ...
            <h1 className="Project__title">Job Inc.</h1>
          </div>
          <div className="Project__b">
            <div className="project__in"></div>
            <h1 className="Project__title">Visit Ethiopia</h1>
      ...
      <div className="Intro">
        ...
        <div className="perspective">
          <div className="Project__c">
            <div className="project__in"></div>
            <h1 className="Project__title">Web Dev Roadmap</h1>
          </div>
          <div className="Project__d">
            <div className="project__in"></div>
            <Link to="/Projects" className="Project__More">More Projects</Link>
          </div>
        </div>
      </div>
    </div>
